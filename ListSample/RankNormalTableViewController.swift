//
//  RankNormalTableViewController.swift
//  ListSample
//
...
class RankNormalTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        performSegue(withIdentifier: "normalToDetail", sender: self)
    }
    ...
    func loadRecord() {
        ...
        let predicate = NSPredicate(format: "harder = 'normal'")
